	     ...
	     <div role="navigation" class="navbar-collapse collapse">
	          ...
	          <ul class="nav navbar-nav" id="topMenu">
				...
				<li class="dropdown ${(index==4)?string('active','')}">
					<a aria-expanded="false" aria-haspopup="true"  role="button" data-toggle="dropdown" class="dropdown-toggle" href="${basePath}/dic/catalog.shtml">
						数据字典管理<span class="caret"></span>
					</a>
					<ul class="dropdown-menu">
						<@shiro.hasPermission name="/dic/catalog.shtml">
							<li><a href="${basePath}/dic/catalog.shtml">字典类别管理</a></li>
						</@shiro.hasPermission>
						<@shiro.hasPermission name="/dic/item.shtml">
							<li><a href="${basePath}/dic/item.shtml">字典项管理</a></li>
						</@shiro.hasPermission>
					</ul>
				</li>	
				</@shiro.hasAnyRoles>   
	           ...
	           <ul class="nav navbar-nav  pull-right" >
				<li class="dropdown ${(index==10)?string('active','')}" style="color:#fff;">
						...
						<a aria-expanded="false" aria-haspopup="true"  role="button" data-toggle="dropdown" 
							...
							${token.nickname?default('游客')}<span class="caret"></span></a>
