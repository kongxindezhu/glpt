			 ...
			 <@shiro.hasPermission name="/role/allocation.shtml">
			  <li class="${(index==2)?string('active',' ')} dropdown">
			      <a href="${basePath}/role/allocation.shtml">
			    	 <i class="glyphicon glyphicon-chevron-right"></i>角色分配(JSP)
			      </a>
			  </li>
			  </@shiro.hasPermission>
...
<#macro dic index>
	<@shiro.hasAnyRoles name='888888,100002'>          
		<div  id="one" class="col-md-2">
			<ul data-spy="affix" class="nav nav-list nav-tabs nav-stacked bs-docs-sidenav dropdown affix" style="top: 100px; z-index: 100;">
			  <li class="${(index==1)?string('active',' ')}">
			      <a href="${basePath}/dic/catalog.shtml">
			    	 <i class="glyphicon glyphicon-chevron-right"></i>字典类别
			      </a>
			  </li>
			  <li class="${(index==2)?string('active',' ')} dropdown">
			      <a href="${basePath}/dic/item.shtml">
			    	 <i class="glyphicon glyphicon-chevron-right"></i>字典项
			      </a>
			  </li>
			</ul>
		</div>
